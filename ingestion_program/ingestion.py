...
def meta_training(agent, D_tr):
    ...
    agent.meta_train(datasets_meta_features, algorithms_meta_features, train_learning_curves,
...
if __name__ == "__main__":
    ...
    from rf_dqn_agent import Agent
    ...
    env = Meta_Learning_Environment(train_data_dir, validation_data_dir, test_data_dir, meta_features_dir,
                                    algorithms_meta_features_dir, output_dir)
